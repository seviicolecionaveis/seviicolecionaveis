...
export type Finish = "Normal" | "Foil" | "Reverse Foil" | "Pokebola" | "Energia" | "Promo" | "Ímã" | "Shattered Holo" | "Illustration Rare" | "Ultra Rara" | "Black Star Promo" | "Double Rare";
...
export const EXTRA_COLLECTIONS = ["151 - Collection 151", "SFA - Fábulas Nebulosas", "SVP - Escarlate e Violeta Promos", "CEL - Celebrações", "MEP - Mega Evolução Promos", "MEW - 151", "VIV - Voltagem Vívida", "ASR - Estrelas Radiantes", "TEF - Forças Temporais", "SSH - Espada e Escudo", "BUS - Sombras Ardentes", "PHF - Força Fantasma", "RCL - Rixa Rebelde", "NBSP - Nintendo Black Star Promos", "EE9 - Astros Cintilantes", "AOR - Origens Ancestrais", "FFI - Punhos Furiosos", "BRS - Astros Cintilantes", "FL - FireRed & LeafGreen", "FCO - Fusão de Destinos", "STS - Cerco de Vapor", "PRC - Conflito Primitivo"];
