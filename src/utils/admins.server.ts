...
export async function listAdminsServer(userId: string) {
...
export async function grantAdminServer(userId: string, emailInput: string) {
  await assertAdmin(userId);
...
export async function revokeAdminServer(userId: string, targetUserId: string) {
  await assertAdmin(userId);
