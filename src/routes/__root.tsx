...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://seviicolecionaveis.lovable.app/" },
...
gtag('config', 'G-2Y61Z4FGFL', { send_page_view: false });`,
      },
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://seviicolecionaveis.lovable.app/",
          logo: "https://seviicolecionaveis.lovable.app/icon-512.png",
        }),
      },
      {
        type: "application/ld+json",
